...
start_date = "08/20/2018 06:00:00"
end_date = "08/20/2018 23:59:59"
...
def by_date(start_date, end_date, chart_title, chart_filename, chart_type, find_what):
    ...
    # For only displaying all the found log file names in the list only.
    print(path_log_names)
...
def plot():
        ...
        width = 0.5
        plt.scatter(y, x, width, color="blue")
