<?php 
    ...
    *********************************************************************/
    ...
    if(!session_start())
    {
        echo "<script> alert('SESSION IS NOT STARTED!'); </script>";
    }
    else
    {
    ...
    *
    *********************************************************************/
    if(isset($_POST['submit']) == "LOG IN" && isset($_POST['login_email']) && isset($_POST['login_password']))
    {
        ...
        $user_login_query = "Select * from user_info where user_email = '$login_email' and user_password = '$login_password'  ";
    ...
    *********************************************************************/
    ...
    if(isset($_POST['submit']) =='Sign Up' && isset($_POST['name']) &&isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm_password']))
    {
        ...
        if($_POST["password"] != $_POST["confirm_password"] && !empty($_POST['confirm_password']))
        {
            $error .= "*Password Confirmation Are Not Matched!<br>";
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                    <i class="dropdown order-1 nav-item">
    ...
    <div class="container">
        <div class="row img_dropshadow img-thumbnail">
